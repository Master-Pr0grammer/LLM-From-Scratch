...
class Transformer(nn.Module):
    def __init__(self, 
        ...
        #attention layers
        self.attention_blocks = nn.Sequential(*[Attention_Block(embedding_dim, ctx_window_length, num_attention_heads, dropout_rate) for i in range(num_attention_blocks)])
